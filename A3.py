...
def showFeatures(img_path : str, imgName : str, model):
    imgName += ".jpg"
...
img_path = '/home/joelsare@unomaha.edu/Documents/A3/ILSVRC2012_val_00009111.JPEG'
showFeatures(img_path, "features", myModel)